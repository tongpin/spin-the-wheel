...
function normalizeLanguageCode(rawCode) {
  const sanitized = (rawCode || "").toLowerCase();
  if (!sanitized) return "en";
  if (sanitized.startsWith("vi")) return "vi";
  if (sanitized.startsWith("es")) return "es";
  if (sanitized.startsWith("pt")) return "pt";
  if (sanitized.startsWith("fr")) return "fr";
  if (sanitized.startsWith("de")) return "de";
  if (sanitized.startsWith("ja")) return "ja";
  if (sanitized.startsWith("ko")) return "ko";
  if (sanitized.startsWith("zh")) return "zh";
  if (sanitized.startsWith("id")) return "id";
  return "en";
}
